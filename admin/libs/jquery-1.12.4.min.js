...
//   // 用户名用户密码验证信息接口地址
//   // var userInfoUrl = baseURL+'/admin/user/info';
//   // 变量放到自调用函数中，外部是访问不到的，我们要让外边的逻辑访问到，所以要将这些变量暴露出去
//   var BigNew = {
//     baseURL = baseURL, //基地址
...
//   };
//   // 暴露接口，目的是为了其他的页面可以访问到
//   // 暴露出去，设置给window，作为全局变量
//   // 随意的添加变量会造成‘全局变量污染’
//   // 因为有太多的接口了，所以不能设置太多的变量，所以将这些用到的接口地址存放到要给对象里面，现在只用一个BigNew变量了。
